    ...
    <div className={styles.container}>
      ...
      <main className={styles.content}>
        ...
        <section className={styles.hero}>
          ...
          <h1>Moving Cities <br /><span className={styles.gradientText}>Forward.</span></h1>
          <p className={styles.lead}>
            We are VeloCity. We believe the future of urban transport is silent, clean, and incredibly fast. 
            Our mission is to replace 100,000 car trips with e-bike rides by 2026.
          </p>
        </section>
        ...
        <section className={styles.valuesSection}>
          ...
          <div className={styles.valueRow}>
            <div className={styles.valueItem}>
              ...
              <p>Every bike is charged using 100% renewable energy sources. We recycle 95% of our battery components.</p>
            </div>
            <div className={styles.valueItem}>
              <h3>🚀 Radical Speed</h3>
              <p>No traffic jams. No parking hunting. Our fleet is optimized for the quickest point-A to point-B travel.</p>
            </div>
            <div className={styles.valueItem}>
              <h3>🛡️ Safety by Design</h3>
              <p>GPS tracking, automatic collision detection, and regular maintenance checks ensure you ride safe.</p>
            </div>
          </div>
        </section>
